...
from data.xc import get_xc_datasets
from data.gc import get_gc_datasets
...
def get_datasets(dataset_name, train_transform, test_transform,args,size_transform=None):
    ...
    unlabelled_train_examples_test.is_train = False
...
def get_class_splits(args):
    ...
    # elif args.dataset_name == 'xc':

    #     args.image_size = 32
    #     args.train_classes = range(6)
    #     args.unlabeled_classes = range(6, 11)
    elif args.dataset_name == 'xc':

        args.image_size = 32
        args.train_classes = range(21)
        args.unlabeled_classes = range(22,22)
    elif args.dataset_name == 'gc':
